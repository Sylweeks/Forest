const lakeImg = document.querySelector('.lake-img')
const hamburgerBtn = document.querySelector('.hamburger')
const mobileMenu = document.querySelector('.mobile-menu')
const mobileMenuBtn = document.querySelector('.mobile-menu-btn')
const mobileMenuAnimation = document.querySelector('.mobile-menu-animation')
const mobileBtnAboutUs = document.querySelector('.mobile-btn-about-us')
const mobileBtnOffers = document.querySelector('.mobile-btn-offers')
...
mobileBtnAboutUs.addEventListener('click', hideHamburgerMenu)
mobileBtnOffers.addEventListener('click', hideHamburgerMenu)
